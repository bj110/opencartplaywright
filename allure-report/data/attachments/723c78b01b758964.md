...
Received: false
    at C:\Automation\opencartplaywright\tests\AddToCart.spec.ts:73:58
```
...
```ts
  ...
  70 |     
  71 |
  72 | //Step 8: Assert success message is visible
> 73 | expect(await productPage.isConfirmationMessageVisible()).toBeTruthy();
     |                                                          ^ Error: expect(received).toBeTruthy()
  74 |
  75 | }
  76 |
